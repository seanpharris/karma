# Prompt: Short Practical Hair Layer

## Queue

- Status: priority
- Asset type: hair-layer
- Target output filename: `hair_short_practical_dark_brown_layer.png`
...
Layer:
Short practical hair, slightly tousled, warm dark brown. Clean silhouette, readable from all 8 directions, suitable for a cozy sci-fi life-sim RPG character. Hair should sit naturally on the bald head without changing the body pose.
