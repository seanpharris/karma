...
- `player_v2_knight_8dir_4row_reference.png`
  ...
  - Prototype movement reference extracted from the user-provided `assets/art/2D Character Knight/` pack because its true 8-direction walk continuity is much better than the generated candidate sheets.
  ...
  - Prototype/reference only until the source/license is confirmed. The active prototype player now prefers `assets/art/sprites/player_v2/player_model_32x64_8dir_runtime.png` when present.
